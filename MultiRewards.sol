...
contract MultiRewardsDMD is ReentrancyGuard, Pausable, Ownable {
    using SafeMath for uint256;
    ...
    IERC20 public constant DMD =
        IERC20(0x90E892FED501ae00596448aECF998C88816e5C0F);
    ...
    function stakeDMD(uint256 amount)
        external
        nonReentrant
        whenNotPaused
        updateReward(msg.sender)
    {
        ...
        DMD.safeTransferFrom(msg.sender, address(this), amount);
        ...
        updateReward(msg.sender)
    {
        ...
        DMD.safeTransfer(msg.sender, amount);
    ...
    function recoverERC20(address tokenAddress, uint256 tokenAmount)
        ...
        onlyOwner
    {
        require(tokenAddress != address(DMD), "Cannot withdraw staking token");
        require(
...
//based on> https://github.com/curvefi/multi-rewards